...
customCodeRegions = OrderedDict([
	...
	#
	# ( 'NTSC 1.02|20XXHP 5.0 Regions', [ ( 0x18DCC0, 0x197B30 ), 		# Tournament Mode Region 	(0x9E70)
	# 								#	 ( 0x32B96C, 0x32C208 ),		# Area 4 of USB/MCC 		(0x89C)		< Can be included if you remove the PAL FSM List (which is currently empty)
	# 									 ( 0x32C998, 0x332834 ), 		# Extra USB/MCC Region 		(0x5E9C)
	# 									 ( 0x39063C, 0x3907F4 ),		# Area 5 of USB/MCC 		(0x1B8)
	# 									 ( 0x438800, 0x446400 ), ] ),	# Data Section 8 			(0xDC00)	Excluding Aux Code Regions to enable OS Report debugging
																				# Total space = 0x1DAC4 Bytes (Or 0x1E360 if you add Area 4 of MCC)
    ...
    # Commented out for SDR, since we use this specially
	...
	('NTSC 1.02|SDR Unused Debug Mode Regions', [
		...
		# (0x3F97F0, 0x3FAC1C),	# We're currently using parts of this for BADHACKS so use the one below instead
		(0x3F98C4, 0x3FAC1C),	# Above commented out item except without badhacks
